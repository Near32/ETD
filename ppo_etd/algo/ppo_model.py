...
from ppo_etd.algo.intrinsic_rewards.deir import DiscriminatorModel
from ppo_etd.algo.intrinsic_rewards.icm import ICMModel
from ppo_etd.algo.intrinsic_rewards.ngu import NGUModel
from ppo_etd.algo.intrinsic_rewards.noveld import NovelDModel
from ppo_etd.algo.intrinsic_rewards.plain_forward import PlainForwardModel
from ppo_etd.algo.intrinsic_rewards.tdd import TDDModel
from ppo_etd.algo.intrinsic_rewards.plain_inverse import PlainInverseModel
...
from ppo_etd.utils.enum_types import ModelType, NormType
...
class PPOModel(ActorCriticCnnPolicy):
    def __init__(
        ...
        erelela_overrides: Optional[Dict[str, Any]] = None,
        erelela_log_dir: Optional[str] = None,
        erelela_enable_wandb: bool = False,
        erelela_wandb_project: Optional[str] = None,
    ):
        self.run_id = run_id
        self.n_envs = n_envs
        self.project_name = project_name
        self.use_wandb_flag = use_wandb
        ...
        self.erelela_enable_wandb = erelela_enable_wandb
        self.erelela_wandb_project = erelela_wandb_project
        ...
        if self.int_rew_source == ModelType.EReLELA:
            self.int_rew_model = EReLELAIntrinsicReward(
                **int_rew_model_kwargs,
                num_envs=self.n_envs,
                erelela_config_path=self.erelela_config_path,
                erelela_overrides=self.erelela_overrides,
                erelela_log_dir=self.erelela_log_dir or '',
                run_id=self.run_id,
