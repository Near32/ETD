...
from ppo_etd.algo.buffers.ppo_buffer import PPORolloutBuffer
from ppo_etd.utils.loggers import StatisticsLogger, LocalLogger
from ppo_etd.utils.common_func import set_random_seed
from ppo_etd.utils.enum_types import ModelType, EnvSrc, DecayType
...
class PPORollout(BaseAlgorithm):
    ...
    def create_intrinsic_rewards(self, new_obs, actions, rewards, dones, infos):
        ...
        elif self.int_rew_source == ModelType.EReLELA:
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            intrinsic_rewards, model_mems = \
                self.create_intrinsic_rewards(new_obs, clipped_actions, rewards, dones, infos)
