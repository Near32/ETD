...
register(
    ...
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv8x8ViewSize9x9'
)
register(
    id='MiniGrid-DoorKey-8x8-ViewSize-5x5-v0',
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv8x8ViewSize5x5'
)
register(
    id='MiniGrid-DoorKey-8x8-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv8x8ViewSize3x3'
)
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-9x9-v0',
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv16x16ViewSize9x9'
)
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-5x5-v0',
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv16x16ViewSize5x5'
)
register(
    id='MiniGrid-DoorKey-32x32-v0',
    entry_point='ppo_etd.env.minigrid_envs:DoorKeyEnv32x32'
)
...
register(
    ...
    entry_point='ppo_etd.env.minigrid_envs:KeyCorridorS6R3V5'
)
register(
    id='MiniGrid-KeyCorridorS6R3V3-v0',
    entry_point='ppo_etd.env.minigrid_envs:KeyCorridorS6R3V3'
)
register(
    id='MiniGrid-KeyCorridorS8R4-v0',
    entry_point='ppo_etd.env.minigrid_envs:KeyCorridorS8R4'
)
register(
    id='MiniGrid-KeyCorridorS10R5-v0',
    entry_point='ppo_etd.env.minigrid_envs:KeyCorridorS10R5'
)
register(
    id='MiniGrid-KeyCorridorS12R6-v0',
    entry_point='ppo_etd.env.minigrid_envs:KeyCorridorS12R6'
)
...
register(
    ...
    entry_point="ppo_etd.env.minigrid_envs:FourRoomsViewSize5x5"
)
register(
    id="MiniGrid-FourRooms-ViewSize-3x3-v0",
    entry_point="ppo_etd.env.minigrid_envs:FourRoomsViewSize3x3"
)
...
register(
    ...
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12'
)
register(
    id='MiniGrid-MultiRoom-N12-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12V3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps1k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps1k'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps1k-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps1kV3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps2k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps2k'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps2k-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps2kV3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps3k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps3k'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps3k-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps3kV3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps500-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps500'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps500-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps500V3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps600-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps600'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps600-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps600V3'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps800-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps800'
)
register(
    id='MiniGrid-MultiRoom-N12-MaxSteps800-ViewSize-3x3-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN12MaxSteps800V3'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps1k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MaxSteps1k'
)
register(
    id='MiniGrid-MultiRoom-N30-ViewSize3x3-MaxSteps1k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30VS3MS1k'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps2k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MaxSteps2k'
)
register(
    id='MiniGrid-MultiRoom-N30-ViewSize3x3-MaxSteps2k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30VS3MS2k'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps3k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MaxSteps3k'
)
register(
    id='MiniGrid-MultiRoom-N30-ViewSize3x3-MaxSteps3k-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30VS3MS3k'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps100-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS100NP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps300-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS300NP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps500-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS500NP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps1k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS1kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps2k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS2kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps3k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS3kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps4k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS4kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps5k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS5kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps6k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS6kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps7k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS7kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps8k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS8kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps9k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS9kNP'
)
register(
    id='MiniGrid-MultiRoom-N30-MaxSteps10k-NoPenalty-v0',
    entry_point='ppo_etd.env.minigrid_envs:MultiRoomEnvN30MS10kNP'
)
...
register(
    ...
    entry_point="ppo_etd.env.minigrid_envs:ObstructedMaze_Full_V3"
)
