...
xvfb-run -a -s "-screen 0 1024x768x24 -ac +extension GLX +render -noreset" python ./ppo_etd/train.py \
    ...
    --exp_name="test_deir_mazeS5_nproc16_nmep4_rnn1_fdim512_lnorm_mlp1_ent1e-2_extR1+intR1e-2_mlr1e-4+ObsQueue=1e5+SEED=10" \
    --use_wandb=1 \
    --project_name="MiniWorld-DEIR-FullMazeS5" \
    --int_rew_coef=1e-2 \
    --ext_rew_coef=1.0 \
